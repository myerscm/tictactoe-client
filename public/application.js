...
var winCondition = function winCondition() {
  ...
  if (board[0] === 'X' && board[0] === board[1] && board[1] === board[2] || board[3] === 'X' && board[3] === board[4] && board[3] === board[5] || board[6] === 'X' && board[6] === board[7] && board[6] === board[8] || board[0] === 'X' && board[0] === board[3] && board[0] === board[6] || board[1] === 'X' && board[1] === board[4] && board[1] === board[7] || board[2] === 'X' && board[2] === board[5] && board[2] === board[8] || board[0] === 'X' && board[0] === board[4] && board[0] === board[8] || board[2] === 'X' && board[2] === board[4] && board[2] === board[6]) {
    console.log('X wins');
    $('#message').html('Player X wins!');
    $('#message').css('background-color', 'green');
    $('.game-board').hide();
    return true;
  } else if (board[0] === 'O' && board[0] === board[1] && board[1] === board[2] || board[3] === 'O' && board[3] === board[4] && board[3] === board[5] || board[6] === 'O' && board[6] === board[7] && board[6] === board[8] || board[0] === 'O' && board[0] === board[3] && board[0] === board[6] || board[1] === 'O' && board[1] === board[4] && board[1] === board[7] || board[2] === 'O' && board[2] === board[5] && board[2] === board[8] || board[0] === 'O' && board[0] === board[4] && board[0] === board[8] || board[2] === 'O' && board[2] === board[4] && board[2] === board[6]) {
    console.log('O wins');
...
var turnSwitch = function turnSwitch(e) {
